...
Level.prototype.obstacleAt = function (pos, size) {
  ...
  //Consider the sides and top and bottum of the level as walls
...
Player.prototype.moveX = function(step, level, keys) {
  ...
  //Find if there is an obsticle at the newPos
...
if (obstacle == "lava"){
  ...
  //the floor is also an obsticle--only allows player to jump is they are touching some obsticle
